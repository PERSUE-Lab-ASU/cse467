...
There is no specific book for this course. The course content will come from multiple books and research papers. Some topics are compiled in this (under construction) `Tutorial<tutorial/_build/html/intro.html>`. Below is a list of books and other resources that cover the content of this tutorial at a much greater depth (and breadth).
